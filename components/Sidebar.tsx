...
const Sidebar: React.FC<SidebarProps> = ({ modules, currentModuleId, completedModules, currentStepIndex, onSelectModule }) => {
  return (
    <div className="w-full lg:w-64 bg-robot-panel border-r border-slate-700/50 flex flex-col hidden lg:flex h-full shadow-2xl z-20">
          ...
          return (
            <div key={module.id} className="mb-2">
              <button
                ...
                className={`w-full text-left px-6 py-3 border-l-4 transition-all hover:bg-slate-800/50 ${isCurrent
                          ...
                          <div className={`flex items-start gap-3 p-2.5 ${isStepCurrent ? 'pl-3.5' : 'pl-2.5'}`}>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between">
                                <span className={`text-xs font-mono font-bold ${isStepCurrent ? 'text-white' :
